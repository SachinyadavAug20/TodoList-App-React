...
const Navbar=()=>{
    ...
    return (
<div style={{backgroundColor:bgColor,color:Color}} className="transition-all border-gray-300 border-t-0 border rounded-b-xl sm:rounded-b-2xl lg:rounded-b-3xl duration-150">
